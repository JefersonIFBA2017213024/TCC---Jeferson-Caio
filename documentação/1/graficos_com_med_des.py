...
columns = ['system_total_stopped', 'system_total_waiting_time', 'system_mean_speed']
stats = {}

for column in columns:
    stats[column] = {
        'Fixed Time': calculate_stats(fixed_time_data, column),
        'Q-learning': calculate_stats(qlearning_data, column),
        'DQN': calculate_stats(dqn_data, column)
    }
